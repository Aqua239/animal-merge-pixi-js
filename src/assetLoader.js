...
export async function loadGameAssets(onProgressCallback) {
    const assetImageList = [
        ...
        { alias: "setting_button", src: "/assets/images/setting_button.svg" },
        { alias: "base_button", src: "/assets/images/base_button.svg" },
        { alias: "replay_icon", src: "/assets/images/icon_white_return.svg" },
        { alias: "main_menu_icon", src: "/assets/images/icon_white_home.svg" },
